...
object SyntaxLibrary {
    ...
    val EXPRESSION = ElementDescription("COMPLETE_EXPRESSION")
    ...
    val EXPRESSION_PART_TARGETED = ElementDescription("EXPRESSION_PART_TARGETED")
    val EXPRESSION_PART_BINARY = ElementDescription("EXPRESSION_PART_BINARY")
    val EXPRESSION_PART_ASSIGNMENT = ElementDescription("EXPRESSION_PART_ASSIGNMENT")
