...
object SyntaxLibrary {
    ...
    val COMPLETE_EXPRESSION = ElementDescription("COMPLETE_EXPRESSION")
    ...
    val EXPRESSION_PREFIX_NEGATE_BOOLEAN = ElementDescription("EXPRESSION_PREFIX_NEGATE_BOOLEAN")
    val EXPRESSION_MATH_OPERATION = ElementDescription("EXPRESSION_MATH_OPERATION")
